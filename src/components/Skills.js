...
function Skills() {
    return (
        <div data-aos="zoom-in-out" className="max-w-4xl mx-auto justify-center py-12" id="tech">
            <p className="text-black text-2xl dark:text-white sm:text-4xl text-center pt-4 font-bold">Tech I Use</p>
            <div className="flex justify-center flex-wrap pt-2">
                {TechsData.map((tech, index) => {
                    return (
                        <div key={index} className="flex flex-col w-40 p-10 m-6 overflow-hidden bg-white dark:bg-zinc-600 shadow-2xl dark:shadow-zinc-800 rounded-xl sm:w-52">
