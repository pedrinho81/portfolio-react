...
function Footer() {
    return (
        <div className="py-5 border-t-2">
            ...
            <div className="flex justify-center mt-4">
                <p className="text-black mb-4">Made with <span className="mr-2" role="link" aria-label="heart">💙</span> by <a className="text-blue-500 hover:underline font-semibold" href="https://www.linkedin.com/in/pedro-henrique81/" rel="noopener" target="_blank" >©Pedro Henrique 2022</a></p>
            </div>
        </div>
    )
}
